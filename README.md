...
I am a **Senior DevOps Engineer** with over 7 years of experience designing, automating, and scaling infrastructure and robust CI/CD pipelines. I specialize in cloud-native technologies, containerization, orchestration, and comprehensive observability stacks, with a strong focus on building secure, resilient, and highly scalable systems.
...
* ☸️ **Advanced Kubernetes Operations:** Multi-cluster management, GitOps workflows, Helm, custom controllers, and ingress/network security policies.
* 🔧 **CI/CD Pipeline Design:** Implementing robust, secure, and fast delivery pipelines with GitHub Actions and Jenkins.
